...
## Test Files
Test files can be found in: <dir>/lib/python3.8/site-packages/source/test_files there are python files and .txt files, make sure to change the file filter down below to be able to see either of them.
